...
- [ ] 3.1.3 Increase test coverage to 90%+
  ...
  - **Package Breakdown**:
    ...
    - Medium coverage (50-80%): interp/types (72.8%), parser (63.9%), bytecode (63.0%), jsonvalue (61.2%), semantic (60.2%), interp/runtime (48.4%), cmd/dwscript/cmd (36.7%)
  ...
  - **Subtasks**:
    ...
    - [ ] 3.1.3.5 Improve bytecode coverage (52.5% → 80%+)
      ...
      - **Current Status**: Package coverage 52.5% → 63.0% (+10.5%, need 17.0% more)
