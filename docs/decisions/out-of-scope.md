...
- **Generics**: ✅ shipped (monomorphization pass, `internal/generics`); remaining gaps tracked in `PLAN.md` §3
- **Lambdas/Anonymous Methods**: ✅ shipped; remaining gaps tracked in `PLAN.md` §3
- **LINQ**: still deferred (`Linq`, `LinqJSON` fixture categories at 0%)
- **Delegates**: still deferred (`DelegateLib` at 0%)
- **Attributes**: still deferred (`AttributesFail` at 0%)
