> **⏸️ Parked.** The AST-driven formatter is deferred until non-host fixture categories reach ≥ 80% (`PLAN.md` §5). This spec is kept as the design input for that work.
