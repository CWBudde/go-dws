...
func RegisterStringFunctions(r *Registry) {
	...
	r.Register("StrSplit", StrSplit, CategoryString, "Splits string into array by delimiter")
	r.Register("StrJoin", StrJoin, CategoryString, "Joins array of strings with delimiter")
	r.Register("StrArrayPack", StrArrayPack, CategoryString, "Removes empty strings from array")
