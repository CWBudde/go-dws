...
func TestExceptionHandlingIntegration(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:       "Ported: Basic Exceptions",
			scriptFile: "../../testdata/exceptions/basic_exceptions.dws",
			wantOutputs: []string{
		...
		{
			name:       "Ported: Re-raise",
			scriptFile: "../../testdata/exceptions/re_raise.dws",
			wantOutputs: []string{
				"Caught once",
				"Caught again",
				"Ended",
		...
		{
			name:       "Ported: Try-Except-Finally",
			scriptFile: "../../testdata/exceptions/try_except_finally.dws",
			wantOutputs: []string{
				"Hello World",
				"Exception World",
				"Bye World",
		...
		},
		{
			...
			scriptFile: "../../testdata/exceptions/except_object.dws",
			wantOutputs: []string{
				"Exception: hello",
				"EMyExcept: world",
				"EMyExcept: world",
		...
		{
			name:       "Ported: Nested Calls",
			scriptFile: "../../testdata/exceptions/nested_calls.dws",
			wantOutputs: []string{
				"Exception1 caught",
			},
			wantInStderr: []string{
		...
		},
		{
			...
			scriptFile: "../../testdata/exceptions/break_in_except.dws",
			wantOutputs: []string{
				"hello",
				"world",
				"duh",
