...
2. Var parameters were already fully implemented in the AST interpreter
3. Only bytecode VM support for var params required new implementation
4. Insert() and Delete() for strings were pre-existing implementations
5. DeleteString was incorrectly listed - it's not a standard DWScript function
